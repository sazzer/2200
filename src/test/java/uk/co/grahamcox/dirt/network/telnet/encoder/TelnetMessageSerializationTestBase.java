...
/**
 * Base class for the Telnet Message Encoder and Decoder tests
 */
public abstract class TelnetMessageSerializationTestBase {
    /**
     ...
     */
    protected abstract void assertMessage(TelnetMessage message, byte... expected);
}
